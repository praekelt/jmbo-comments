...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('comments_yalcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('object_pk', self.gf('django.db.models.fields.TextField')()),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['comments.YALComment'])),
        ...
        db.send_create_signal('comments', ['YALComment'])

        # Adding M2M table for field like_users on 'YALComment'
        db.create_table('comments_yalcomment_like_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('yalcomment', models.ForeignKey(orm['comments.yalcomment'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('comments_yalcomment_like_users', ['yalcomment_id', 'user_id'])

        # Adding model 'YALCommentFlag'
        db.create_table('comments_yalcommentflag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.YALComment'])),
        ...
        db.send_create_signal('comments', ['YALCommentFlag'])

        # Adding M2M table for field flag_users on 'YALCommentFlag'
        db.create_table('comments_yalcommentflag_flag_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('yalcommentflag', models.ForeignKey(orm['comments.yalcommentflag'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('comments_yalcommentflag_flag_users', ['yalcommentflag_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('comments_yalcomment')

        # Removing M2M table for field like_users on 'YALComment'
        db.delete_table('comments_yalcomment_like_users')

        # Deleting model 'YALCommentFlag'
        db.delete_table('comments_yalcommentflag')

        # Removing M2M table for field flag_users on 'YALCommentFlag'
        db.delete_table('comments_yalcommentflag_flag_users')
    ...
    models = {
        ...
        'comments.yalcomment': {
            ...
            'object_pk': ('django.db.models.fields.TextField', [], {}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['comments.YALComment']"}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
            'submit_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'to': "orm['auth.User']"})
        },
        'comments.yalcommentflag': {
            'Meta': {'object_name': 'YALCommentFlag'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['comments.YALComment']"}),
