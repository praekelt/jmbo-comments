...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'YALCommentFlag.flag'
        db.add_column('comments_yalcommentflag', 'flag', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'YALCommentFlag.reason'
        db.add_column('comments_yalcommentflag', 'reason', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'YALCommentFlag.flag'
        db.delete_column('comments_yalcommentflag', 'flag')

        # Deleting field 'YALCommentFlag.reason'
        db.delete_column('comments_yalcommentflag', 'reason')
