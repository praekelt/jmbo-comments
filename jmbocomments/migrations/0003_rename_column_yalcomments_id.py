...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('jmbocomments_usercomment_like_users', 'yalcomment_id', 'usercomment_id')
        

    def backwards(self, orm):
        
        db.rename_column('jmbocomments_usercomment_like_users', 'usercomment_id', 'yalcomment_id')
