...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('jmbocomments_yalcomment', 'jmbocomments_usercomment')
        # Renaming M2M table for field like_users on 'YALComment'
        db.rename_table('jmbocomments_yalcomment_like_users', 'jmbocomments_usercomment_like_users')
        # Renaming model 'YALCommentFlag'
        db.rename_table('jmbocomments_yalcommentflag', 'jmbocomments_usercommentflag')
        # Renaming M2M table for field flag_users on 'YALCommentFlag'
        db.rename_table('jmbocomments_yalcommentflag_flag_users', 'jmbocomments_usercommentflag_flag_users')


    def backwards(self, orm):
        
        db.rename_table('jmbocomments_usercomment', 'jmbocomments_yalcomment')
        db.rename_table('jmbocomments_usercomment_like_users', 'jmbocomments_yalcomment_like_users')
        db.rename_table('jmbocomments_usercommentflag', 'jmbocomments_yalcommentflag')
        db.rename_table('jmbocomments_usercommentflag_flag_users', 'jmbocomments_yalcommentflag_flag_users')
